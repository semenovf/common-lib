...
1. [UUID версии 7, или как не потеряться во времени при создании идентификатора](https://habr.com/ru/post/572700/)
2. [ULID - Universally Unique Lexicographically Sortable Identifier](https://github.com/ulid/spec)
3. [ULID - C++ port](https://github.com/suyash/ulid)
4. [New UUID Formats](https://datatracker.ietf.org/doc/html/draft-peabody-dispatch-new-uuid-format-01)
